package com.java.collections.linkedhashset.org;
...
public class Test {
	...
	/*
	 * LinkedHashSet allows unique values and it do not allows duplicates values and it follows insertion order.
	...
	public static void main(String[] args) {
		...
		System.out.println("------------------------------------");
		System.out.println(products.contains(p5)); // this method gives the status of element present in the LinkedHashSet or
													// not.
