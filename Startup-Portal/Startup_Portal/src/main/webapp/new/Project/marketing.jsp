...
<head>
   ...
   <!-- Site Title- -->
   <title>Startup -marketing</title>

   <!-- CSS
   ==================================================== -->
   <!--Font Awesome -->
   <link rel="stylesheet" href="css/font-awesome.minm.css" />

   <!-- Animate CSS -->
   <link rel="stylesheet" href="css/animatem.css">

   <!-- Iconic Fonts -->
   <link rel="stylesheet" href="css/icofontsm.css" />

   <!-- Bootstrap CSS -->
   <link rel="stylesheet" href="css/bootstrap.minm.css">

   <!-- Owl Carousel -->
   <link rel="stylesheet" href="css/owlcarousel.minm.css" />

   <!-- Video Popup -->
   <link rel="stylesheet" href="css/magnific-popupm.css" />

   <!--Style CSS -->
   <link rel="stylesheet" href="css/stylem.css">

   <!--Responsive CSS -->
   <link rel="stylesheet" href="css/responsivem.css">
...
<body>
   ...
   <nav class="navbar navbar-expand-lg navbar-light bg-light bg-transparent" id="gtco-main-nav">
       <div class="container"><a class="navbar-brand">Startup</a>
           <button class="navbar-toggler" data-target="#my-nav" onclick="myFunction(this)" data-toggle="collapse"><span
                   class="bar1"></span> <span class="bar2"></span> <span class="bar3"></span></button>
           <div id="my-nav" class="collapse navbar-collapse">
               <ul class="navbar-nav mr-auto">
                   <li class="nav-item"><a class="nav-link" href="index.jsp#">Home</a></li>
                   <li class="nav-item"><a class="nav-link" href="index.jsp#service">Services</a></li>
                   <li class="nav-item"><a class="nav-link" href="index.jsp#about">About</a></li>
                   <li class="nav-item"><a class="nav-link" href="index.jsp#blogs">blogs</a></li>
            ...
            <div class="slider-inner d-table-cell">
               <div class="container">
                  <div class="row justify-content-center">
                     <div class="col-md-12">
                        <img src="images/seo1.jpg" alt="" class="slider-img img-fluid">
                     </div>
                     <!-- Col End -->
                  </div>
                  <!-- Row End -->
            ...
            <div class="slider-inner d-table-cell">
               <div class="container">
                  <div class="row justify-content-center">
                     ...
                     <!-- Col end -->
                     <div class="col-md-6">
                        <img src="images/se02.jpg" alt="" class="img-fluid slider-img">
                     </div>
                     <!-- col end -->
                  </div>
                  <!-- Row End -->
            ...
            <div class="slider-inner d-table-cell">
               <div class="container">
                  <div class="row justify-content-center">
                     ...
                     <div class="col-md-6">
                        <div class="slider-content">
                           <h1>How to do social marketing ... ?
                              
                           <p>Start working with an company that provide everything you need to social marketing !</p>
         ...
         <div class="row">
            <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".2s">
               <div class="features-box">
                  ...
                  <p>Social marketing has the primary goal of achieving "social good". Traditional commercial marketing aims are primarily financial, though they can have positive social effects as well.
                  </p>
            ...
            <div class="col-lg-4 col-md-12  wow fadeInUp" data-wow-duration="1.6s" data-wow-delay=".4s">
               <div class="features-box">
                  ...
                  <p>Search engine optimization is the process of increasing the quality and quantity of website traffic by increasing the visibility of a website or a web page to users of a web search engine
                  </p>
                  <a href="https://www.wordstream.com/seo" class="tw-readmore">Read More
                     <i class="fa fa-angle-right"></i>
                  </a>
               </div>
               <!-- End Single Features -->
            ...
            <div class="col-lg-4 col-md-12  wow fadeInUp" data-wow-duration="1.9s" data-wow-delay=".6s">
               <div class="features-box">
                  ...
                  <p>What is SEO management? SEO management can refer to your company or your agency's management of your SEO strategy. As a part of SEO management, your team or agency develops,
                  </p>
                  <a href="https://www.webfx.com/blog/seo/what-is-seo-management/" class="tw-readmore">Read More
                     <i class="fa fa-angle-right"></i>
                  </a>
               </div>
               <!-- End Single Features -->
      ...
      <div class="container">
         <div class="row">
            ...
            <div class="col-lg-6 col-md-12 text-lg-right text-md-center wow fadeInLeft" data-wow-duration="1s">
              <img src="images/mark.jpg" alt="" class="img-fluid">
            ...
            <div class="col-lg-5 ml-auto col-md-12 wow fadeInRight" data-wow-duration="1s">
               ...
               <p>
                 When it comes to usability and user experience, the difference is more subtle – which is why people may use them interchangeably. Usability is concerned with satisfaction, effectiveness and efficiency that specific users (maybe visitors to a site or testers) achieve “specific” goals. UX on the other hand is concerned with users interacting with the product or service and all aspects of that experience.
               </p>
               <!-- End Intro list -->
               <a href="https://www.invespcro.com/blog/usability-101-designing-for-a-better-user-experience/" class="btn btn-primary">learn more</a>
               <!-- Default Round Btn -->
...
<footer class="container-fluid" id="gtco-footer">
                ...
                <div class="row">
                    <div class="col-6">
                        ...
                        <ul class="nav flex-column company-nav">
                            ...
                            <li class="nav-item"><a class="nav-link" href="index.jsp#about">About</a></li>
                            <li class="nav-item"><a class="nav-link" href="index.jsp#blogs">blogs</a></li>
                            <li class="nav-item"><a class="nav-link" href="index.jsp#contact" onclick="collectchat.open()">Contact</a></li>
                        </ul>
                    ...
                    <div class="col-6">
                        ...
                        <ul class="nav flex-column services-nav">
                            <li class="nav-item"><a class="nav-link" href="loan.jsp">Loan Facility</a></li>
                            <li class="nav-item"><a class="nav-link" href="marketing.jsp">Marketing Solution</a></li>
                            <li class="nav-item"><a class="nav-link" href="investors.jsp">Investors</a></li>
                            <li class="nav-item"><a class="nav-link" href="employees.jsp">Employees Availability</a></li>
                            <li class="nav-item"><a class="nav-link" href="office.jsp">Office Spaces</a></li>
                            <li class="nav-item"><a class="nav-link" href="buisness.jsp">Buisness Analytics</a></li>
                        </ul>
                    </div>
                    <div class="col-12">
                    </div>
   ...
   <script src="js/jquery-2.0.0.minm.js"></script>
   <!-- Popper JS -->
   <script src="js/popper.minm.js"></script>
   <!-- Bootstrap jQuery -->
   <script src="js/bootstrap.minm.js"></script>
   <!-- Owl Carousel -->
   <script src="js/owl-carousel.2.3.0.minm.js"></script>
   <!-- Waypoint -->
   <script src="js/waypoints.minm.js"></script>
   <!-- Counter Up -->
   <script src="js/jquery.counterup.minm.js"></script>
   <!-- Video Popup -->
   <script src="js/jquery.magnific.popupm.js"></script>
   <!-- Smooth scroll -->
   <script src="js/smoothscrollm.js"></script>
   <!-- WoW js -->
   <script src="js/wow.minm.js"></script>
   <!-- Template Custom -->
