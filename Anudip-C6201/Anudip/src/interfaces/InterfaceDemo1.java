 ...
 * 	  the keyword public and abstract agian and again in the code or in the methods.
 * 2) All variables in the interfaces are automatically public static and final
 * 
 * 3) Interfaces objects cannot be created. --->> Because it is abstract methods means incomplete methods
 * 	  
...
class SurajS implements ClothingApp11 {
...
public class InterfaceDemo1 {
	public static void main(String[] args) {
		SurajS s = new SurajS();
		System.out.println(s.addToCart("T-Shirt added"));
	}
}
